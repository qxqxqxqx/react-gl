 ...
 * @Date: 2020-09-03 18:42:54
 * @LastEditors: qiaoxin
 * @LastEditTime: 2020-09-03 18:50:09
...
export default function GltfModel(props: any): ReactElement {
  ...
  useEffect(() => {
    ...
    if (wrapRef.current) {
      ...
      loader.load(`${process.env.PUBLIC_URL}/models/CesiumMan/CesiumMan.gltf`, function (result) {
